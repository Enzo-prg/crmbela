        ...
        <div class="section-header ticket-sec-mbl-hdr">
            ...
            <div class="section-header-breadcrumb float-right">
                <div class="mr-3 ipad-margin-left">
                    {{Form::select('status', $statusArr, null, ['id' => 'ticketStatus', 'class' => 'form-control', 'placeholder' => 'Select Status']) }}
                </div>
            </div>
            <div class="float-right mr-3">
                {{ Form::select('priority', $ticketPriorityArr, null, ['class' => 'form-control', 'id' => 'ticketPriorityId', 'placeholder' => 'Select Ticket Priority']) }}
            </div>
