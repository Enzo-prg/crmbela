                                    ...
                                    @foreach($notes as $note)
                                        <div class="activity clearfix notes__information"
                                            ...
                                            <div class="activity-detail col-xl-11 col-lg-10 pt-1 mb-3">
                                                ...
                                                <div
                                                        class="user__comment mt-2 @if($note->added_by == getLoggedInUserId()) note-display @endif {{'note-display-'.$note->id}}"
                                                        data-id="{{$note->id}}">
                                                    {!! html_entity_decode($note->note) !!}
                                                </div>
                                                @if($note->added_by == getLoggedInUserId())
                                                    <div
                                                            class="user__comment d-none comment-edit {{'comment-edit-'.$note->id}}">
