        ...
        <div class="row">
            <div class="col-md-6 col-sm-12">
                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        ...
                        {{ Form::text('zip[1]', (isset($data['billingAddress']) && $data['billingAddress']['zip']!=null)?$data['billingAddress']['zip']:null, ['class' => 'form-control', 'id' => 'billingZip','onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'autocomplete' => 'off']) }}
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-12">
            ...
            <div class="col-md-6 col-sm-12">
                        ...
                        <div class="card-header-action">
                            <span class="remove-underline">
                                <a id="copyBillingAddress" class="text-black-50">
                                    <input type="checkbox" id="shippingAddressCheck" class="mr-1" {{ isset($data['shippingAddress']) && $data['shippingAddress']['street'] ? 'checked' : 'disabled' }}>{{__('messages.customer.copy_billing_address')}}</a>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        {{ Form::label('zip', __('messages.customer.zip_code').':') }}
                        {{ Form::text('zip[2]', (isset($data['shippingAddress']) && $data['shippingAddress']['zip']!=null)?$data['shippingAddress']['zip']:null, ['class' => 'form-control', 'id' => 'shippingZip','onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'autocomplete' => 'off']) }}
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-12">
