    ...
    <div class="card my-4 shadow ">
        <div class="card-body">
            <div class="col-12">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <p class="invoice-company-name m-0 text-muted font-weight-bold">{{ $estimate->customer->company_name }}</p>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 estimateDetail">
                        ...
                        <div class="invoice-date d-table float-right">
                            <div class="d-table-row">
                                ...
                                <div class="d-table-cell">{{ !empty($estimate->estimate_date) ? Carbon\Carbon::parse($estimate->estimate_date)->format('jS M, Y') : __('messages.common.n/a')}}</div>
                            </div>
                            <div class="d-table-row">
                                <div class="d-table-cell text-right font-weight-bold text-muted pr-1">{{ __('messages.estimate.expiry_date').':' }}</div>
                                <div class="d-table-cell">{{ !empty($estimate->estimate_expiry_date) ? Carbon\Carbon::parse($estimate->estimate_expiry_date)->format('jS M, Y') : __('messages.common.n/a')}}</div>
                            </div>
            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-12">
                        <p class="font-weight-bold">{{ __('messages.estimate.client_note').':' }}</p>
