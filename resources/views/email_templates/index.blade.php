        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <div class="card-header-action mr-3">
                    {{Form::select('template_type', $templateTypeArr, null, ['id' => 'filterTemplate', 'class' => 'form-control', 'placeholder' => 'Select Template Type']) }}
                </div>
                <div class="card-header-action mr-3">
                    {{ Form::select('disabled', $disabledEmailTemplate, null, ['id' => 'filterDisabledTemplate', 'class' => 'form-control','placeholder' => 'Select Email Template']) }}
                </div>
            </div>
        </div>
