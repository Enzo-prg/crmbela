    ...
    <div class="row">
        ...
        @forelse($goals as $goal)
            ...
            <div class="col-12 col-md-6 col-lg-4 col-xl-4 extra-large">
                <div class="livewire-card card {{ $loop->odd ? 'card-primary' : 'card-dark'}} shadow mb-5 rounded user-card-view hover-effect-goal card-height-goal">
                    <div class="p-2 pb-0">
                ...
                <div class="card-header d-flex align-items-center user-card-index d-sm-flex-wrap-0">
                    <div class="ml-2 w-100 mb-auto">
                        ...
                        <div class="card-body pt-1 pl-0 pb-0 pr-0">
                            ...
                            <div class="line-height-20px">
                                <label class="font-weight-bold">{{__('messages.goal.achievement')}}: </label>
                        ...
                        <div class="card-body d-flex justify-content-start align-items-center pt-0 pb-2 pl-0 pr-0">
                            <div class="d-Class">
                                @foreach($goal->goalMembers as $counter => $member)
                                    @if($counter < 5)
                                        <a href="{{ url('admin/members/'.$member->id) }}"><img
                                                    class="goal-avatar-image p-0"
                                                    src="{{ $member->image_url }}"
                                                    title="{{ html_entity_decode($member->full_name) }}"></a>
