    ...
    <div class="row">
        <div class="mt-0 mb-3 col-12 d-flex justify-content-end livewire-search">
            @if(!empty($customer))
                <div class="mt-2 mr-2 m-r-0">
                    {{ Form::select('payment_status',$creditNoteStatus,$filterStatus,['id' => 'creditNoteStatus','class' => 'form-control','placeholder' => 'Select Status']) }}
                </div>
            @endif
        ...
        @forelse($creditNotes as $creditNote)
            <div class="col-12 col-md-6 col-xl-3 col-xlg-4">
                <div class="credit-note-card card card-{{ \App\Models\CreditNote::STATUS_COLOR[$creditNote->payment_status] }} shadow mb-5 rounded hover-card card-height height-210">
                    ...
                    <div class="card-body d-flex justify-content-between pt-1 px-3">
                        <div class="d-table w-100">
                            ...
                            <span class="mt-mobile-2 badge badge-{{ \App\Models\CreditNote::STATUS_COLOR[$creditNote->payment_status] }} text-uppercase">
