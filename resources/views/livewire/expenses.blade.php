        ...
        <div class="mt-0 mb-3 col-12 d-flex justify-content-end livewire-search">
            @if(!empty($customer))
                <div class="mt-2 m-r-0">
                    {{ Form::select('expense_category',$expenseCategoryArr, $categoryFilter,['id' => 'expenseCategoryCustomer','class' => 'form-control','placeholder' => 'Select Expense Category']) }}
                </div>
            @endif
        ...
        @empty
            <div class="mt-0 mb-5 col-12 d-flex justify-content-center  mb-5 rounded">
                <div class="p-2">
                    ...
                    @else
                        <p class="text-dark">{{ __('messages.expense.no_expense_found') }}</p>
                    @endif
                </div>
            </div>
        @endforelse
