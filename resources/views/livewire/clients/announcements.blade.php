        ...
        <div class="col-12 mb-3">
            <div class="hover-effect-announcement position-relative mb-4 announcement-height"
                ...
                <div class="announcement-listing-details">
                    ...
                    <div class="ml-2">
                        <span>{!! !empty($announcement->message) ? Str::limit($announcement->message, $limit = 150, $end = '...') : __('messages.common.n/a') !!}</span>
                    </div>
    ...
    @empty
        <div class="mt-0 mb-5 col-12 d-flex justify-content-center mb-5 rounded">
            <div class="p-2">
                ...
                @else
                    <p class="text-dark">{{ __('messages.announcement.no_announcement_found') }}</p>
                @endif
            </div>
        </div>
    @endforelse
