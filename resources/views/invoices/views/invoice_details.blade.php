        ...
        <div class="d-flex justify-content-end align-items-center">
            <div class="dropdown d-inline">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    @if($invoice->payment_status != \App\Models\Invoice::STATUS_DRAFT && $invoice->payment_status != \App\Models\Invoice::STATUS_UNPAID && $invoice->payment_status != \App\Models\Invoice::STATUS_PAID)
