    ...
    <div class="row">
        ...
        <div class="form-group col-lg-4 col-md-6 col-sm-12">
            ...
            <div class="input-group">
                ...
                {{ Form::text('invoice_number', isset($invoice->invoice_number) ? $invoice->invoice_number : generateUniqueInvoiceNumber(), ['class' => 'form-control', 'required', 'id' => 'invoiceNumber','readonly']) }}
            </div>
        </div>
        <div class="form-group col-lg-4 col-md-6 col-sm-12">
        ...
        <div class="form-group col-lg-4 col-md-6 col-sm-12">
            ...
            <div class="input-group">
                ...
                {{ Form::text('invoice_date', isset($invoice->invoice_date) ? $invoice->invoice_date : null, ['class' => 'form-control invoiceDate', 'required', 'autocomplete' => 'off']) }}
            </div>
        </div>
        <div class="form-group col-lg-4 col-md-6 col-sm-12">
            ...
            <div class="input-group">
                ...
                {{ Form::text('due_date', isset($invoice->due_date) ? $invoice->due_date : null, ['class' => 'form-control invoiceDueDate','autocomplete' => 'off']) }}
            </div>
        </div>
        <div class="form-group col-lg-4 col-md-6 col-sm-12">
        ...
        <div class="form-group col-lg-4 col-md-6 col-sm-12">
            {{ Form::label('discount_type', __('messages.invoice.discount_type').':') }}<span
                    class="required">*</span>
            {{ Form::select('discount_type', $data['discountType'], isset($invoice->discount_type) ? $invoice->discount_type : null, ['class' => 'form-control', 'id' => 'discountTypeSelect', 'placeholder' => 'Select discount type','required']) }}
        </div>
        ...
        <div class="form-group col-lg-12 col-md-12 col-sm-12 overflow-section">
            <table class="table table-responsive-sm table-responsive-md table-striped table-bordered">
                ...
                <tr>
                    ...
                    <th class="small-column">{{ __('messages.item.rate') }}(<i data-set-currency-class="true"></i>)
                ...
                <tr>
                    <td><input type="text" name="item[]" id="item" class="form-control item-name" required></td>
                    <td><textarea name="description[]" class="form-control item-description"></textarea></td>
                    <td><input type="text" name="quantity[]" id="quantity" class="form-control qty" required min="0">
                    </td>
                    <td><input type="text" name="rate[]" id="rate" class="form-control rate" required></td>
                    <td class="">
