<aside id="sidebar-wrapper">
        ...
        <a class="navbar-brand d-flex align-items-center justify-content-center py-3 px-2"
           href="{{ route('redirect.login') }}">
            <img class="navbar-brand-full w-25"
                 ...
                 alt="">&nbsp;&nbsp;
            <span class="navbar-brand-full-name text-black text-wrap pl-2 w-75">Afrel</span>
        </a>
    ...
    <div class="sidebar-brand sidebar-brand-sm">
        <a href="{{ route('redirect.login') }}" class="small text-white">
            <img class="navbar-brand-full" src="{{getAppLogo() ?? asset('img/infyom-logo2.png') }}"
                 width="50px" alt="">
        </a>
    </div>
    ...
    <ul class="sidebar-menu">
        ...
        @canany(['manage_articles','manage_article_groups'])
            <li class="nav-item d-none dropdown side-menus">
        ...
        @endcanany
        @can('manage_tags')
            <li class="side-menus d-none {{ Request::is('admin/tags*') ? 'active' : '' }}">
        ...
        @canany(['manage_tasks','manage_tickets','manage_ticket_priority','manage_ticket_statuses','manage_predefined_replies'])
            ...
            @endcan
            <li class="nav-item dropdown side-menus d-none">
        ...
        @canany(['manage_settings'])
            ...
            @endcan
        @endcanany
        <li class="side-menus d-none {{ Request::is('admin/countries*') ? 'active' : '' }}">
