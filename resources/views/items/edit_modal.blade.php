                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 col-lg-6 col-md-12">
                        {{ Form::label('item_group ', __('messages.item.item_group').':') }}<span
                                class="required">*</span>
                        <div class="input-group">
                            {{ Form::select('item_group_id', $data['itemGroups'], null, ['class' => 'form-control', 'required', 'id' => 'editItemGroup','placeholder' => 'Select Product Group']) }}
                    ...
                    <div class="form-group col-sm-12 col-lg-6 col-md-12">
                        ...
                        {{ Form::select('tax_1_id', $data['taxes'], null, ['class' => 'form-control', 'id' => 'editTaxSelectOne','placeholder' => 'Select Tax 1']) }}
                    </div>
                    <div class="form-group col-sm-12 col-lg-6 col-md-12">
                        {{ Form::label('tax_2 ', __('messages.item.tax').' 2:') }}
                        {{ Form::select('tax_2_id', $data['taxes'], null, ['class' => 'form-control', 'id' => 'editTaxSelectTwo','placeholder' => 'Select Tax 2']) }}
                    </div>
                </div>
