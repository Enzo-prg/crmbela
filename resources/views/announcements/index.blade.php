        ...
        <div class="section-header announcement-sec-header">
            ...
            <div class="section-header-breadcrumb float-right">
                <div class="card-header-action mr-3">
                    {{ Form::select('status', $statusArr, null, ['id' => 'filterAnnouncementStatus', 'class' => 'form-control', 'placeholder' => 'Select Status']) }}
                </div>
            </div>
            <div class="float-right mr-3">
                {{ Form::select('show_to_client', $showToClientArr, null, ['class' => 'form-control', 'id' => 'showToClientId', 'placeholder' => 'Select Show To Client']) }}
            </div>
