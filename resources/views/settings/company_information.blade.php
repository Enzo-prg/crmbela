<div class="row">
    ...
    <div class="form-group col-sm-6">
        {{ Form::label('company', __('messages.company.company').':') }}<span
                class="required">*</span>
        {{ Form::text('company', $settings['company'], ['class' => 'form-control','id' => 'companyNameId', 'required']) }}
    </div>
    <div class="form-group col-sm-6">
...
<div class="row">
    <div class="form-group col-sm-12">
        {{ Form::label('address', __('messages.company.address').':') }}<span
                class="required">*</span>
        {{ Form::textarea('address', $settings['address'], ['class' => 'form-control textarea-sizing', 'id' => 'addressId', 'required', 'rows' => '5']) }}
    </div>
</div>
<div class="row">
    <!-- Submit Field -->
