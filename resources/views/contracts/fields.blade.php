<div class="row">
    ...
    <div class="form-group col-sm-6">
        ...
        <div class="input-group">
            {{ Form::select('contract_type_id',$contractType, null, ['id'=>'contractTypeId','required','class' => 'form-control','placeholder' => 'Select Contract Type']) }}
...
<div class="row">
    <div class="form-group col-sm-6">
        ...
        {{ Form::select('customer_id',$customer, isset($customerId) ? $customerId : null, ['id'=>'customer','class' => 'form-control','required','placeholder' => 'Select Customer']) }}
    </div>
    <div class="form-group col-sm-6">
...
<div class="row">
    <div class="form-group col-sm-12 col-lg-6 col-md-12">
        ...
        <div class="input-group">
            ...
            {{ Form::text('start_date', isset($contract->start_date) ? $contract->start_date : null, ['class' => 'form-control startDate','autocomplete' => 'off']) }}
        </div>
    </div>
    <div class="form-group col-sm-12 col-lg-6 col-md-12">
        ...
        <div class="input-group">
            ...
            {{ Form::text('end_date', isset($contract->end_date) ? $contract->end_date : null, ['class' => 'form-control endDate','autocomplete' => 'off']) }}
        </div>
    </div>
</div>
<div class="row">
