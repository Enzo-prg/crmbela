...
<div class="card-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
            ...
            {{ Form::select('customer_id', $data['customers'], isset($creditNote->customer_id) ? $creditNote->customer_id : null, ['class' => 'form-control', 'required', 'id' => 'customerSelectBox', 'placeholder' => 'Select Customer']) }}
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
            ...
            <div class="input-group">
                ...
                {{ Form::text('credit_note_number', isset($creditNote->credit_note_number) ? $creditNote->credit_note_number : generateUniqueInvoiceNumber(), ['class' => 'form-control', 'required', 'id' => 'creditNoteNumber']) }}
            </div>
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
            ...
            <div class="input-group">
                ...
                {{ Form::text('credit_note_date', isset($creditNote->credit_note_date) ? date('Y-m-d H:i:s', strtotime($creditNote->credit_note_date)) : null, ['class' => 'form-control datepicker', 'required', 'autocomplete' => 'off']) }}
            </div>
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
            ...
            <select id="creditNoteCurrencyId" data-show-content="true" class="form-control currency-select-box"
                ...
                <option value="0" disabled="true" {{ isset($creditNote->currency) ? '' : 'selected' }}>Select Currency
                </option>
                @foreach($data['currencies'] as $key => $currency)
                    <option value="{{$key}}" {{ (isset($creditNote->currency) ? $creditNote->currency : null) == $key ? 'selected' : ''}}>
        ...
        <div class="form-group col-lg-12 col-md-12 col-sm-12 overflow-section">
            <table class="table table-responsive-sm table-responsive-md table-striped table-bordered" id="itemTable">
                ...
                <tr>
                    ...
                    <th class="small-column">{{ __('messages.item.rate') }}(<i data-set-currency-class="true"></i>)<span
    ...
    <div class="row">
        <div class="form-group col-lg-2 col-md-6 col-sm-12">
            ...
            <p><i data-set-currency-class="true"></i> <span class="footer-numbers sub-total"
        ...
        <div class="form-group col-lg-3 col-md-6 col-sm-12">
            <div class="fDiscount form-group">
                ...
                <div class="input-group">
                    {{ Form::text('final_discount', $creditNote->discount, ['class' => 'form-control footer-discount-input']) }}
                    <div class="input-group-append">
                        ...
                        <select class="input-group-text dropdown" id="footerDiscount" name="discount_symbol">
                            <div class="dropdown-menu">
                                <option value="1"
                                        class="dropdown-item" {{ isset($creditNote->discount_symbol) && $creditNote->discount_symbol == 1 ?  'selected':'' }}>
                                    %
                                </option>
                                <option value="2"
                                        class="dropdown-item" {{ isset($creditNote->discount_symbol) && $creditNote->discount_symbol == 2 ?  'selected':'' }}>{{ __('messages.invoice.fixed') }}</option>
                            </div>
                        </select>
                    </div>
                </div>
        ...
        <div class="form-group col-lg-3 col-md-6 col-sm-12">
            ...
            {{ Form::number('adjustment', $creditNote->adjustment, ['class' => 'form-control', 'id' => 'adjustment','autocomplete' => 'off']) }}
        </div>
        <div class="form-group col-lg-3 col-md-6 col-sm-12">
