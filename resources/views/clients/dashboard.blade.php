    ...
    <div>enzo</div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title font-weight-bold text-dark">{{ __('messages.invoice.quick_invoices_info') }}</div>
                    </div>
                    <div class="card-body">
                        <canvas id="invoiceInfoChart" width="400" height="150"></canvas>
                    </div>
                </div>
            </div>
        </div>
...
@section('scripts')
    <script>
        let invoicesData = JSON.parse('@json($monthsWiseInvoice)');
        let allMonths = JSON.parse('@json($months)');
    </script>
    <script src="{{ mix('assets/js/chart/Chart.min.js') }}"></script>
    <script src="{{ mix('assets/js/clients/invoices/invoice-info-chart.js') }}"></script>
@endsection
