        ...
        <div class="form-group col-md-4 col-12">
            ...
            <p>
                @forelse($project->projectContacts as $contact)
                    <span class="badge badge-light mb-1">{{ html_entity_decode($contact->user->full_name) }} </span>
                @empty
        ...
        <div class="form-group col-md-4 col-12">
            ...
            <p>
                @forelse($project->members as $member)
                    <span class="badge badge-light mb-1">{{ html_entity_decode($member->user->full_name) }} </span>
                @empty
                    {{ __('messages.common.n/a') }}
                @endforelse
            </p>
        ...
        <div class="form-group col-md-4 col-12">
            ...
            <p>
                @forelse($project->tags as $tag)
                    <span class="badge badge-light mb-1">{{ html_entity_decode($tag->name) }} </span>
                @empty
                    {{ __('messages.common.n/a') }}
                @endforelse
            </p>
