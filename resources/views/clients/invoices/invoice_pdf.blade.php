                            ...
                            <table class="invoice-date-table">
                                <tr>
                                    <td class="text-right font-weight-bold"
                                        style="width: 70%;">{{ __('messages.invoice.invoice_date').': ' }}</td>
                                    <td>{{ !empty($invoice->invoice_date) ? Carbon\Carbon::parse($invoice->invoice_date)->format('jS M, Y') : __('messages.common.n/a') }}</td>
                                </tr>
                                <tr>
                                    <td class="text-right font-weight-bold"
                                        style="width: 70%;">{{ __('messages.invoice.due_date').': ' }}</td>
                                    <td>{{ !empty($invoice->due_date) ? Carbon\Carbon::parse($invoice->due_date)->format('jS M, Y') : __('messages.common.n/a') }}</td>
                                </tr>
