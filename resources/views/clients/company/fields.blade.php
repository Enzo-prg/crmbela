<div class="row">
    <div class="col-md-6 col-sm-12">
        ...
        <div class="form-group col-sm-12">
            ...
            {{ Form::select('default_language',$data['default_language'],null,['class' => 'form-control','id' => 'languageId', 'placeholder' => 'Select Language']) }}
        </div>
    </div>
    <div class="col-md-6 col-sm-12">
        <div class="form-group col-sm-12">
        ...
        <div class="form-group col-sm-12">
            ...
            {{ Form::select('country', $data['countries'], null, ['id'=>'countryId','class' => 'form-control','placeholder' => 'Select Country']) }}
        </div>
    </div>
</div>
