...
function addCommentSection (comment) {
    ...
    if (comment.added_by == authId) {
        icons = '                    <a class="user__icons del-comment d-none task-comment-delete" title="delete" data-id="' +
            id + '"><i class="fas fa-trash ml-0 card-delete-icon"></i></a>\n' +
            '                    <a class="user__icons edit-comment d-none task-comment-edit" title="edit" data-id="' +
            id +
