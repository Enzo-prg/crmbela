...
$(document).ready(function () {
    ...
    $('.datepicker, .due-datepicker').on('dp.show', function () {
        matchWindowScreenPixels(
            { datepicker: '.datepicker', dueDatePicker: '.due-datepicker' },
            'exp');
    });
    ...
    if (typeof editProposalAddress !== 'undefined' && editProposalAddress) {
    ...
    $(document).on('click', '#btnSaveAddress', function () {
        ...
        if (typeof createProposalAddress !== 'undefined' &&
            ...
            if (checkAddressFields().length == 0) {
                ...
                $('#address_to').
                    html(createAddressDetail(addressingAddressForm));
            }
        }
