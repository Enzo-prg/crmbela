...
$(tableName).DataTable({
    ...
    ajax: {
        ...
        data: function (data) {
            ...
            data.fabricante = $('#fabricanteId').find('option:selected').val();
        },
        complete: function () {
            stopLoader();
        },
    ...
    columns: [
        ...
        {
            data: function (row) {
                return fabricantes[row.fabricante];
            },
            name: 'fabricante',
        },
        {
        ...
        },
        {
            data: function (row) {
                if (row.member_id !== null) {
                    return '<a href="' + memberUrl + '/' + row.member_id +
    ...
    'fnInitComplete': function () {
        ...
        $(document).on('change', '#fabricanteId', function () {
            $(tableName).DataTable().ajax.reload(null, true);
        });
    },
});
