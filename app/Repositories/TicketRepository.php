...
class TicketRepository extends BaseRepository
{
    ...
    public function getSyncList()
    {
        ...
        $data['contacts'] = Contact::with('user')->get()->where('user.is_enable', '=', true)->pluck('user.full_name',
            'id');
        $data['departments'] = Department::orderBy('name', 'asc')->pluck('name', 'id');
        ...
        $data['ticketStatus'] = TicketStatus::orderBy('name', 'asc')->pluck('name', 'id');
        $data['services'] = Service::orderBy('name', 'asc')->pluck('name', 'id');
        $data['tags'] = Tag::orderBy('name', 'asc')->pluck('name', 'id')->toArray();
        $data['predefinedReplies'] = PredefinedReply::orderBy('reply_name', 'asc')->pluck('reply_name', 'id');
