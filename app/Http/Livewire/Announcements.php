...
class Announcements extends SearchableComponent
{
    ...
    public function searchAnnouncements()
    {
        ...
        $this->getQuery()->when($this->showToClientFilter !== '', function (Builder $query) {
            $query->where('show_to_clients', $this->showToClientFilter);
        });
     ...
     * @param $id
     */
    public function filterShowToClient($id)
    {
        $this->showToClientFilter = $id;
    }
}
